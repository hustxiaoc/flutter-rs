...
GLFWAPI int glfwGetInputMode(GLFWwindow* handle, int mode)
{
    ...
    printf("glfwGetInputMode mode = %d\n", mode);
    switch (mode)
    {
        case GLFW_CURSOR:
            printf("GLFW_CURSOR\n");
        ...
        case GLFW_STICKY_KEYS:
            printf("GLFW_STICKY_KEYS\n");
            return window->stickyKeys;
        case GLFW_STICKY_MOUSE_BUTTONS:
            printf("GLFW_STICKY_MOUSE_BUTTONS\n");
            return window->stickyMouseButtons;
        case GLFW_LOCK_KEY_MODS:
            printf("GLFW_LOCK_KEY_MODS\n");
            return window->lockKeyMods;
        case GLFW_RAW_MOUSE_MOTION:
            printf("GLFW_RAW_MOUSE_MOTION\n");
...
GLFWAPI void glfwSetPreeditCursorPos(GLFWwindow* handle, int x, int y, int h)
{
    ...
    printf("glfwSetPreeditCursorPos called from c %d %d %d\n", x, y, h);
}
...
{
    printf("glfwSetIMEStatusCallback\n");
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
