...
impl Window {
    ...
    pub fn set_preedit_cursor_pos(&mut self, xpos: i32, ypos: i32, h: i32) {
        println!("call set_preedit_cursor_pos {} {} {}", xpos, ypos, h);
        unsafe {
            ffi::glfwSetPreeditCursorPos(self.ptr, xpos as c_int, ypos as c_int, h as c_int);
        }
    }
